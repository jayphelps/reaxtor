...
function toString() {
    return "SparseArray {" + "length: " + this._length + ", " + "size: " + this.end(this.getLength() - 1) + ", " + "[blocks: " + this.block_table.length + "]" + ", " + "gap: " + this._gap + ", " + "defaultSize: " + this._defaultSize + ", " + "pendingRemoves: " + (this.removes ? this.removes.length : 0) + ", " + "pendingInserts: " + (this.inserts ? this.inserts.length : 0) + "}";
}
