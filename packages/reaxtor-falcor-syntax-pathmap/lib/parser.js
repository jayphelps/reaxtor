  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c26 = function(head, tail) {
          var result = {}, i, keyIndex = -1, keys = result.$keys = [];
          if (Array.isArray(head.name)) {
            head.name.forEach(function(key) {
              keyIndex++;
              keys.push(key);
              if (head.value !== undefined) {
                result[keyIndex] = head.value;
              }
            });
          }
          else {
          ...
          for (i = 0; i < tail.length; i++) {
            if (Array.isArray(tail[i].name)) {
                tail[i].name.forEach(function(key) {
                    keyIndex++;
                    keys.push(key);
                    if (tail[i].value !== undefined) {
                      result[keyIndex] = tail[i].value;
                    }
                });
            } else {
                keyIndex++;
                keys.push(tail[i].name);
                if (tail[i].value !== undefined) {
                  result[keyIndex] = tail[i].value;
                }
            }
        ...
        peg$c46 = function(from, to) { return { from:Math.min(from, to), length:Math.max(from, to)-Math.min(from, to)} },
        peg$c47 = "..",
        peg$c48 = { type: "literal", value: "..", description: "\"..\"" },
        peg$c49 = function(from, to) { return { from:Math.min(from, to), length:Math.max(from, to)-Math.min(from, to)+1} },
        peg$c50 = "-",
        ...
        peg$c85 = /^[^\0-\x1F"'\\]/,
        peg$c86 = { type: "class", value: "[^\\0-\\x1F\\x22\\x27\\x5C]", description: "[^\\0-\\x1F\\x22\\x27\\x5C]" },
        peg$c87 = /^[0-9]/,
        ...
        peg$c105 = { type: "class", value: "[\\u02B0-\\u02C1\\u02C6-\\u02D1\\u02E0-\\u02E4\\u02EC\\u02EE\\u0374\\u037A\\u0559\\u0640\\u06E5-\\u06E6\\u07F4-\\u07F5\\u07FA\\u081A\\u0824\\u0828\\u0971\\u0E46\\u0EC6\\u10FC\\u17D7\\u1843\\u1AA7\\u1C78-\\u1C7D\\u1D2C-\\u1D6A\\u1D78\\u1D9B-\\u1DBF\\u2071\\u207F\\u2090-\\u209C\\u2C7C-\\u2C7D\\u2D6F\\u2E2F\\u3005\\u3031-\\u3035\\u303B\\u309D-\\u309E\\u30FC-\\u30FE\\uA015\\uA4F8-\\uA4FD\\uA60C\\uA67F\\uA69C-\\uA69D\\uA717-\\uA71F\\uA770\\uA788\\uA7F8-\\uA7F9\\uA9CF\\uA9E6\\uAA70\\uAADD\\uAAF3-\\uAAF4\\uAB5C-\\uAB5F\\uFF70\\uFF9E-\\uFF9F]", description: "[\\u02B0-\\u02C1\\u02C6-\\u02D1\\u02E0-\\u02E4\\u02EC\\u02EE\\u0374\\u037A\\u0559\\u0640\\u06E5-\\u06E6\\u07F4-\\u07F5\\u07FA\\u081A\\u0824\\u0828\\u0971\\u0E46\\u0EC6\\u10FC\\u17D7\\u1843\\u1AA7\\u1C78-\\u1C7D\\u1D2C-\\u1D6A\\u1D78\\u1D9B-\\u1DBF\\u2071\\u207F\\u2090-\\u209C\\u2C7C-\\u2C7D\\u2D6F\\u2E2F\\u3005\\u3031-\\u3035\\u303B\\u309D-\\u309E\\u30FC-\\u30FE\\uA015\\uA4F8-\\uA4FD\\uA60C\\uA67F\\uA69C-\\uA69D\\uA717-\\uA71F\\uA770\\uA788\\uA7F8-\\uA7F9\\uA9CF\\uA9E6\\uAA70\\uAADD\\uAAF3-\\uAAF4\\uAB5C-\\uAB5F\\uFF70\\uFF9E-\\uFF9F]" },
