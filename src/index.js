...
const patch = snabbdom.init([ sdClass, sdProps, sdStyle, sdEventlisteners ]);
...
export { reaxtor, hJSX, List, Model, Event, Component, SparseArray };

function reaxtor(model, RootComponentClass, node) {
    ...
    return new RootComponentClass({ models }).scan(patch, node);
}
